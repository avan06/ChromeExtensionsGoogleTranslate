...
(function() {
  ...
  */
  var aa = function(a) {
    ...
    ea = function(a, b) {
      if (b) a: {
        ...
        a = a[a.length - 1];e = c[a];b = b(e);b != e && null != b && ba(c, a, {
          configurable: !0,
          writable: !0,
          value: b
        })
  ...
  var va, E;
  a: {
    for (var wa = ["CLOSURE_FLAGS"], F = k, xa = 0; xa < wa.length; xa++)
      if (F = F[wa[xa]], null == F) {
        E = null;
        break a
      } E = F
  ...
  var Ga = function(a) {
    ...
    Ia = function(a, b) {
      ...
      a: {
        ...
        if (c.querySelector && (c = c.querySelector("script[nonce]")) && (c = c.nonce || c.getAttribute("nonce")) && Ha.test(c)) break a;c = ""
      }
    ...
    function c() {
      ...
      return e.run(function() {
        var g = a.call,
          ...
          l = [f],
          G = l.concat;
        if (d instanceof Array) var x = d;
        else {
          if (x = "undefined" != typeof Symbol && Symbol.iterator && d[Symbol.iterator]) x = x.call(d);
          else if ("number" == typeof d.length) x = {
            next: aa(d)
          };
