...
(function() {
  ...
  */
  ...
  var ob = function(a) {
    ...
    xb = function(a) {
      if (!qb.test(a)) return a; - 1 != a.indexOf("&") && (a = a.replace(rb, "&amp;")); - 1 != a.indexOf("<") && (a = a.replace(sb, "&lt;")); - 1 != a.indexOf(">") && (a = a.replace(tb, "&gt;")); - 1 != a.indexOf('"') && (a = a.replace(ub, "&quot;")); - 1 != a.indexOf("'") && (a = a.replace(vb, "&#39;")); - 1 != a.indexOf("\x00") && (a = a.replace(wb, "&#0;"));
      return a
    },
    rb = /&/g,
    sb =
  ...
  k.ra = function(a) {
    Kc(this);
    var b = [];
    if ("string" === typeof a) Lc(this, a) && (b = b.concat(this.g.get(String(a))));
    else {
  ...
  */
  ...
  var Wc = new Vc("OFF", Infinity),
    Xc = new Vc("SEVERE", 1E3),
    Yc = new Vc("WARNING", 900),
    Zc = new Vc("CONFIG", 700),
    $c = new Vc("FINE", 500),
    ad = function() {
      this.clear()
    },
  ...
  var Id = ec(),
    ...
    Ld = H && C("Mobile"),
    Md = Fd(),
    Nd = Cd() ? "Windows" === ac.platform : C("Windows"),
    Od = Cd() ? "Android" === ac.platform : C("Android"),
    Pd = Dd(),
    Qd = C("iPad"),
    Rd = C("iPod"),
    Sd = Ed(),
  ...
  */
  ...
  zg.prototype.add = function(a, b, c, d, e) {
    ...
    a = this.g[f];
    a || (a = this.g[f] = [], this.l++);
    var h = Ag(a, b, d, e); - 1 < h ? (b = a[h], c || (b.ab = !1)) : (b = new xg(b, this.src, f, !!d, e), b.ab = c, a.push(b));
    return b
  };
  ...
  var Cg = "closure_lm_" + (1E6 * Math.random() | 0),
    ...
    Ng = function(a, b, c, d, e) {
      if (Array.isArray(b))
        for (var f = 0; f < b.length; f++) Ng(a, b[f], c, d, e);
      else d = t(d) ? !!d.capture : !!d, c = Hg(c), vg(a) ? a.fa(b, c, d, e) : a && (a = Jg(a)) && (b = a.Pa(b, c, d, e)) && Og(b)
    },
    Og = function(a) {
    ...
    Pg = function(a) {
      if (a)
        if (vg(a)) a.V && a.V.removeAll(void 0);
        else if (a = Jg(a)) {
        var b = 0,
          c;
        for (c in a.g)
          for (var d = a.g[c].concat(), e = 0; e < d.length; ++e) Og(d[e]) && ++b
      }
    },
    Lg = function(a) {
  ...
  k.dispatchEvent = function(a) {
    ...
    b = this.Cc;
    d = a.type || a;
    if ("string" === typeof a) a = new qg(a, b);
    else if (a instanceof qg) a.target = a.target || b;
    else {
      var e = a;
      a = new qg(d, b);
      eb(a, e)
    ...
    if (c)
      for (f = 0; !a.l && f < c.length; f++) h = a.g = c[f], e = Sg(h, d, !1, a) && e;
    return e
  };
  k.H = function() {
    K.I.H.call(this);
  ...
  L.prototype.fa = function(a, b, c, d, e) {
    if (Array.isArray(b))
      for (var f = 0; f < b.length; f++) this.fa(a, b[f], c, d, e);
    else c = c || this.handleEvent, d = t(d) ? !!d.capture : !!d, e = e || this.J || this, c = Hg(c), d = !!d, b = vg(a) ? a.Pa(b, c, d, e) : a ? (a = Jg(a)) ? a.Pa(b, c, d, e) : null : null, b && (Og(b), delete this.u[b.key]);
    return this
  };
  ...
  bh.prototype.ya = function() {
    if (!this.o) fh(this), this.F = this.l = null;
  ...
  bh.prototype.ha = function(a, b, c, d, e, f) {
    ...
    this.M != e && (this.M && !ob(Bc(this.M)) && tf(this.g.A(), this.M), ob(Bc(e)) || rf(this.g.A(), e), this.M =
      e);
    Df(this.g.A(), 0, 0);
    if (b instanceof D) Rc(this.g.g, b);
    else
      for (He(this.g.g); c = b.firstChild;) this.g.g.appendChild(c);
    this.B.l = a;
    this.B.u()
  };
  var fh = function(a) {
  ...
  k.Gc = function(a) {
    if (H || Jd)
      if (17 == this.X && !a.ctrlKey || 18 == this.X && !a.altKey || Md && 91 == this.X && !a.metaKey) this.pa = this.X = -1; - 1 == this.X && (a.ctrlKey && 17 != a.keyCode ? this.X = 17 : a.altKey && 18 != a.keyCode ? this.X = 18 : a.metaKey && 91 != a.keyCode && (this.X = 91));
  ...
  k.sb = function(a, b) {
    ...
    } else if (F && (c = c ? "on" : "", a.setAttribute("unselectable", c), b))
  ...
  var Wi = function(a) {
      if (a.o && "undefined" != typeof ua)
        ...
        else if (a.K && 4 == Xi(a)) Tg(a.ua, 0, a);
      else if (a.dispatchEvent("readystatechange"), 4 == Xi(a)) {
        ld(a.l, Qi(a, "Request complete"));
        a.o = !1;
        try {
          if (Yi(a)) a.dispatchEvent("complete"), a.dispatchEvent("success");
          else {
            try {
    ...
    for (f in a) {
      if (A(a.hasOwnProperty(f))) {
        ...
        if (null != g) {
          ...
          }(e), h.m ? l = l(g) : (g = La(g).map(l), l = g.length ? g : null);
          else b: {
            switch (typeof g) {
              case "string":
              case "number":
  ...
  var Z = function(a, b) {
    a = a || [];
    if (kj(a)) b && b > a.length && !Aj(a) && nj(a, b), qj(a, this);
    else {
          ...
          if (g) {
            ...
            if (d) {
              ...
              for (n = 0; n < l; n++) {
                ...
                if (a)
                  for (p = p.terms, u = p.length, x = 0; x < u; x++) q += (0 != x ? ", " : "") + fe(p[x]);
                else
                  for (p = p.terms, u = p.length, x = 0; x < u; x++) {
                    var E = p[x];
                    q += 3 > x ? (0 != x ? ", " : "") + fe(E) : ""
                  }
                q += "</td></tr>"
            ...
            if (null != e) {
              ...
              if (e instanceof kb) e = lb(e);
                ...
                if (f.toLowerCase() in qc)
                  if (e instanceof nb) e instanceof nb && e.constructor === nb ? e = e.g : (B("expected object of type TrustedResourceUrl, got '" + e + "' of type " + wa(e)), e = "type_error:TrustedResourceUrl"), e = e.toString();
                  else if (e instanceof Bb) e = Cb(e);
                else if ("string" === typeof e) e = (Fb(e) || Gb).ea();
                else throw Error('Attribute "' + f + '" on tag "div" requires goog.html.SafeUrl, goog.string.Const, or string, value "' +
                  e + '" given.');
              }
              e.sa && (e = e.ea());
  ...
  Gg(window, "mouseup", function(a) {
    if (0 == a.button && !ue(document, "gtx-trans")) {
      ...
      Ai || "1" != wi.g || !wi.u || Sm ? window.setTimeout(w($m, a), 0) : (Tm = a, chrome.runtime.sendMessage({
        detectLanguage: 1
      }))
    }
  });
